...
def main():
    ...
    formula = input('Please enter the Chemical formula you wish to search for: ')
    # Get the mass of a chemical sample in grams from the user.
    chemMass = float(input('Please enter the mass of the sample in Grams: '))
    ...
    pformula = parse_formula(formula, periodic_table)
    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    molarMass = compute_molar_mass(pformula,periodic_table)
